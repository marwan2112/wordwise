// listeningBank.js - بنك الأسئلة السماعية
window.listeningBank = {
    A1: [
        { id: "A1_01", audio: "audio/level_test/A1 Q01.mp4", text: "What is the man's name?", options: ["Tim", "Tony", "Tom", "Ted"], correct: "Tom", transcript: "Woman: Hello. What's your name? Man: My name is Tom. Woman: Nice to meet you, Tom. Man: Nice to meet you too." },
        { id: "A1_02", audio: "audio/level_test/A1 Q02.mp4", text: "Where is the cat?", options: ["On the chair", "Behind the door", "Under the table", "On the floor"], correct: "Under the table", transcript: "Man: Where is the cat? Woman: It's under the table. Man: Oh yes, I see it now." },
        { id: "A1_03", audio: "audio/level_test/A1 Q03.mp4", text: "How many apples are in the bag?", options: ["One", "Two", "Three", "Four"], correct: "Two", transcript: "Woman: What do you have in your bag? Man: I have two apples and a banana. Woman: No sandwich? Man: No, no sandwich today." },
        { id: "A1_04", audio: "audio/level_test/A1 Q04.mp4", text: "Who is at the door?", options: ["The man's mother", "The man's friend", "The man's sister", "The man's neighbour"], correct: "The man's sister", transcript: "Man: Who is it? Woman: It's Sarah, your sister. Man: Okay, coming." },
        { id: "A1_05", audio: "audio/level_test/A1-Q05.mp3", text: "When is the museum closed?", options: ["On Sundays", "On Tuesdays", "On Saturdays", "On Mondays"], correct: "On Mondays", transcript: "Woman: Is the museum open today? Man: No, it's closed on Mondays. Come back tomorrow. Woman: Okay, thank you." },
        { id: "A1_06", audio: "audio/level_test/A1-Q06.mp3", text: "What does the boy choose to drink?", options: ["Juice", "Water", "Tea", "Milk"], correct: "Milk", transcript: "Boy: Mum, can I have some juice? Mother: There's no juice. We have water or milk. Boy: Okay, I'll have milk, please." },
        { id: "A1_07", audio: "audio/level_test/A1-Q07.mp3", text: "Where is the library?", options: ["Next to the school", "Next to the post office", "Opposite the park", "Behind the supermarket"], correct: "Next to the post office", transcript: "Woman: Excuse me, where is the library? Man: Go straight, then turn left. It's next to the post office. Woman: Thank you very much." },
        { id: "A1_08", audio: "audio/level_test/A1-Q08.mp3", text: "Which page do the students open to?", options: ["Two", "Twenty", "Twelve", "Thirty"], correct: "Twelve", transcript: "Teacher: Class, open your books to page twelve. Student: Sorry, is that page twelve or twenty? Teacher: Page twelve. One-two." },
        { id: "A1_09", audio: "audio/level_test/A1-Q09.mp3", text: "How much does the coffee cost?", options: ["One pound fifty", "Two pounds", "Two pounds fifty", "Three pounds"], correct: "Two pounds fifty", transcript: "Man: How much is this coffee? Cashier: That's two pounds fifty. Man: Here you go." },
        { id: "A1_10", audio: "audio/level_test/A1-Q10.mp3", text: "What time does the shop close on a normal day?", options: ["Four o'clock", "Five o'clock", "Six o'clock", "Seven o'clock"], correct: "Six o'clock", transcript: "Woman: What time does the shop close? Man: It closes at six o'clock in the evening. Woman: And does it open on Sundays? Man: Yes, but only until two o'clock." },
        { id: "A1_11", audio: "audio/level_test/A1-Q11.mp3", text: "Where were the shoes?", options: ["By the front door", "In the kitchen", "In the wardrobe", "Under the bed"], correct: "Under the bed", transcript: "Girl: Dad, where are my shoes? Father: I think they're by the front door. Girl: No, they're not there. Father: Did you look under your bed? Girl: Oh yes! Found them!" },
        { id: "A1_12", audio: "audio/level_test/A1-Q12.mp3", text: "Where does this bus go?", options: ["To the city centre", "To the train station", "To the airport", "To the hospital"], correct: "To the airport", transcript: "Man: Excuse me. Is this the bus to the city centre? Driver: No, this bus goes to the airport. You need the number seven. Man: Thank you." },
        { id: "A1_13", audio: "audio/level_test/A1-Q13.mp3", text: "What is the weather like?", options: ["Hot and sunny", "Cold and raining", "Windy and cloudy", "Cold and snowing"], correct: "Cold and raining", transcript: "Woman: What's the weather like today? Man: It's very cold and it's raining heavily. Woman: Oh no. I left my umbrella at home." },
        { id: "A1_14", audio: "audio/level_test/A1-Q14.mp3", text: "Where can the customer find birthday cards?", options: ["On the ground floor", "Near the entrance", "On the second floor", "At the checkout"], correct: "On the second floor", transcript: "Shop assistant: Can I help you? Customer: Yes, I'm looking for a birthday card. Shop assistant: The cards are on the second floor, near the lifts. Customer: Thank you." },
        { id: "A1_15", audio: "audio/level_test/A1-Q15.mp3", text: "Why is this Jack's first day?", options: ["He is visiting", "He just moved to a new school", "He is a new teacher", "He forgot his bag"], correct: "He just moved to a new school", transcript: "Boy: Hi. My name's Jack. What's your name? Girl: I'm Layla. Are you new here? Boy: Yes. Today is my first day. Girl: Welcome! I'll show you around." },
        { id: "A1_16", audio: "audio/level_test/A1-Q16.mp3", text: "How many sisters does the man have?", options: ["One", "Two", "Three", "None"], correct: "Two", transcript: "Woman: Do you have any brothers or sisters? Man: Yes, I have one brother and two sisters. Woman: Are you the oldest? Man: No, my brother is the oldest." },
        { id: "A1_17", audio: "audio/level_test/A1-Q17.mp3", text: "Which vegetable does the child not like?", options: ["Peas", "Beans", "Carrots", "Potatoes"], correct: "Carrots", transcript: "Mother: Eat your vegetables, please. Child: I don't like carrots. Mother: What about the peas? Child: Okay. I like peas." },
        { id: "A1_18", audio: "audio/level_test/A1-Q18.mp3", text: "When is the next train?", options: ["Three o'clock", "Half past two", "Half past three", "Quarter to four"], correct: "Half past three", transcript: "Man: When does the next train leave? Station staff: The next train is at half past three. Man: And after that? Station staff: There's one at five o'clock." },
        { id: "A1_19", audio: "audio/level_test/A1-Q19.mp3", text: "What time is the man's appointment?", options: ["Nine o'clock", "Ten o'clock", "Eleven o'clock", "Half past ten"], correct: "Ten o'clock", transcript: "Receptionist: Good morning. Can I help you? Man: Yes. I have an appointment with Dr. Harris at ten o'clock. Receptionist: Your name, please? Man: James Carter." },
        { id: "A1_20", audio: "audio/level_test/A1-Q20.mp3", text: "When did the man last visit London?", options: ["Last year", "Two years ago", "Three years ago", "Five years ago"], correct: "Three years ago", transcript: "Woman: Is this your first time in London? Man: No, I came here three years ago with my family. Woman: Did you enjoy it? Man: Yes, very much. We visited the Tower of London and Hyde Park." },
        { id: "A1_21", audio: "audio/level_test/A1-Q21.mp3", text: "Why is the swimming pool closed?", options: ["It is being repaired", "It is being cleaned", "There are no lifeguards today", "It is too cold"], correct: "It is being cleaned", transcript: "Announcement: The swimming pool is closed this afternoon for cleaning. It will reopen tomorrow morning at eight o'clock." },
        { id: "A1_22", audio: "audio/level_test/A1-Q22.mp3", text: "How long until the supermarket closes?", options: ["Five minutes", "Ten minutes", "Fifteen minutes", "Twenty minutes"], correct: "Fifteen minutes", transcript: "Announcement: Attention, shoppers. The supermarket will close in fifteen minutes. Please bring your items to the checkout now. Thank you." },
        { id: "A1_23", audio: "audio/level_test/A1-Q23.mp3", text: "Which chapters should the students study?", options: ["Chapters one and two", "Chapters three and four", "Chapters four and five", "Chapters five and six"], correct: "Chapters four and five", transcript: "Teacher: Class, we have a test next Friday. Please study chapters four and five." },
        { id: "A1_24", audio: "audio/level_test/A1-Q24.mp3", text: "Which bus should passengers use instead?", options: ["Number 12", "Number 14", "Number 20", "Number 22"], correct: "Number 22", transcript: "Announcement: The number 14 bus service is cancelled today due to a road accident. Please use the 22 bus as an alternative." },
        { id: "A1_25", audio: "audio/level_test/A1-Q25.mp3", text: "How much is the fine per day for late books?", options: ["Twenty pence", "Fifty pence", "One pound", "Two pounds"], correct: "Fifty pence", transcript: "Library announcement: Please remember to return borrowed books within two weeks. After two weeks, a fine of fifty pence per day will be charged." },
        { id: "A1_26", audio: "audio/level_test/A1-Q26.mp3", text: "What size pizza does the man order?", options: ["Small", "Large", "Medium", "Extra large"], correct: "Medium", transcript: "Man: I'd like a pizza, please. Waiter: Would you like it small, medium, or large? Man: Medium, please. And with extra cheese. Waiter: Anything to drink? Man: Just water, thank you." },
        { id: "A1_27", audio: "audio/level_test/A1-Q27.mp3", text: "Why is the man taking the train?", options: ["He doesn't have a car", "His car is being repaired", "He missed the bus", "He lives near the station"], correct: "His car is being repaired", transcript: "Woman: Excuse me. Is this seat taken? Man: No, please sit down. Woman: Thank you. Is this your first time on this train? Man: Yes. I usually drive, but my car is being repaired." },
        { id: "A1_28", audio: "audio/level_test/A1-Q28.mp3", text: "Why does the mother say no to the biscuit?", options: ["There are no biscuits left", "The child is not hungry", "It will spoil the child's appetite", "The child doesn't like biscuits"], correct: "It will spoil the child's appetite", transcript: "Child: Mum, I'm hungry. Mother: Lunch will be ready in ten minutes. Child: Can I have a biscuit? Mother: No, it will spoil your appetite. Wait for lunch." },
        { id: "A1_29", audio: "audio/level_test/A1-Q29.mp3", text: "What does the clerk ask for?", options: ["The man's address", "His phone number", "A form of ID", "His date of birth"], correct: "A form of ID", transcript: "Man: Good morning. I'd like to open a bank account, please. Clerk: Of course. Do you have some form of ID? Man: Yes, here is my passport. Clerk: Thank you. Please take a seat and someone will help you shortly." },
        { id: "A1_30", audio: "audio/level_test/A1-Q30.mp3", text: "What symptoms does the girl have?", options: ["Stomach ache and a fever", "A headache and sore throat", "Sore eyes and a cough", "A cold and earache"], correct: "A headache and sore throat", transcript: "Girl: I don't feel well. Teacher: What's wrong? Girl: I have a headache and a sore throat. Teacher: Let me call your parents." },
        { id: "A1_31", audio: "audio/level_test/A1-Q31.mp3", text: "Where can the man buy stamps?", options: ["At the shop", "At the supermarket", "At the post office", "At the library"], correct: "At the post office", transcript: "Man: Do you sell newspapers? Shop owner: Yes, they're at the front of the shop. Man: And do you sell stamps? Shop owner: No, you'll need to go to the post office for those." },
        { id: "A1_32", audio: "audio/level_test/A1-Q32.mp3", text: "Where was the phone?", options: ["In her jacket pocket", "On the table", "Under the sofa", "In her bag"], correct: "In her bag", transcript: "Woman: I can't find my phone. Man: Did you check your jacket pocket? Woman: Yes. Oh wait, here it is, it was in my bag all along." },
        { id: "A1_33", audio: "audio/level_test/A1-Q33.mp3", text: "When can the boy go to bed?", options: ["At eight o'clock", "At half past eight", "At nine o'clock", "At ten o'clock"], correct: "At nine o'clock", transcript: "Father: It's time for bed. Son: But Dad, my favourite programme is on. Father: It finishes at nine. You can watch until then. Son: Thanks, Dad." },
        { id: "A1_34", audio: "audio/level_test/A1-Q34.mp3", text: "How much change does the customer receive?", options: ["Six pounds", "Seven pounds", "Eight pounds", "Nine pounds"], correct: "Eight pounds", transcript: "Cashier: That comes to twelve pounds, please. Customer: Here's a twenty. Cashier: And here's eight pounds change." },
        { id: "A1_35", audio: "audio/level_test/A1-Q35.mp3", text: "What does the man need to do first?", options: ["Take the number three bus", "Walk to the hospital", "Cross the road", "Call a taxi"], correct: "Cross the road", transcript: "Man: How do I get to the hospital from here? Woman: Take the number five bus from the stop across the road. It's about fifteen minutes. Man: Is there a bus stop on this side? Woman: No, you need to cross the road first." },
        { id: "A1_36", audio: "audio/level_test/A1-Q36.mp3", text: "How many nights is Mr. Wilson staying?", options: ["One night", "Two nights", "Three nights", "Four nights"], correct: "Three nights", transcript: "Hotel receptionist: Welcome to the Grand Hotel. Do you have a reservation? Guest: Yes, under the name Wilson. Receptionist: Yes, Mr. Wilson. You have a room for three nights." },
        { id: "A1_37", audio: "audio/level_test/A1-Q37.mp3", text: "What kind of food does the café serve?", options: ["Full meals and pizza", "Sandwiches and soup", "Burgers and chips", "Only drinks"], correct: "Sandwiches and soup", transcript: "Woman: Is there a café near here? Man: Yes, there's one on the corner, just two minutes away. Woman: Do they serve hot food? Man: I think they do sandwiches and soup, but not full meals." },
        { id: "A1_38", audio: "audio/level_test/A1-Q38.mp3", text: "How many legs does a spider have?", options: ["Four", "Six", "Eight", "Ten"], correct: "Eight", transcript: "Child: How many legs does a spider have? Teacher: A spider has eight legs. Child: More than a dog? Teacher: Yes. A dog has four legs." },
        { id: "A1_39", audio: "audio/level_test/A1-Q39.mp3", text: "Why does the man want to return the jacket?", options: ["It doesn't fit", "He doesn't like the colour", "The zip is broken", "It was the wrong size"], correct: "The zip is broken", transcript: "Man: I'd like to return this jacket, please. Shop assistant: Do you have the receipt? Man: Yes, here it is. Shop assistant: Is there a problem with it? Man: Yes, the zip is broken." },
        { id: "A1_40", audio: "audio/level_test/A1-Q40.mp3", text: "Why isn't the man's brother coming to the party?", options: ["He is ill", "He has to work", "He is travelling", "He forgot about it"], correct: "He has to work", transcript: "Woman: Is your brother coming to the party? Man: No. He has to work this weekend. Woman: That's a pity. Will he come next time? Man: I hope so." },
        { id: "A1_41", audio: "audio/level_test/A1-Q41.mp3", text: "What colour is the front door of the man's house?", options: ["White", "Blue", "Green", "Red"], correct: "Red", transcript: "Man: My house has a red front door and a small garden. There are two big trees in the garden. The house is white with a blue roof." },
        { id: "A1_42", audio: "audio/level_test/A1-Q42.mp3", text: "What time does the woman start work?", options: ["Seven o'clock", "Half past seven", "Eight o'clock", "Nine o'clock"], correct: "Nine o'clock", transcript: "Woman: I wake up at seven every morning. I have breakfast at half past seven, then I walk to work. I start work at nine." },
        { id: "A1_43", audio: "audio/level_test/A1-Q43.mp3", text: "How old is the dog?", options: ["One year old", "Two years old", "Three years old", "Four years old"], correct: "Three years old", transcript: "Boy: My dog is called Max. He is brown and white. He loves to run in the park. He is three years old." },
        { id: "A1_44", audio: "audio/level_test/A1-Q44.mp3", text: "Where is the woman going on holiday?", options: ["Spain", "France", "Greece", "Italy"], correct: "Italy", transcript: "Woman: I'm going on holiday next month. I'm flying to Italy. I'll stay for ten days. I'm very excited." },
        { id: "A1_45", audio: "audio/level_test/A1-Q45.mp3", text: "What topic will the class study in the morning?", options: ["Fish", "Insects", "Birds", "Mammals"], correct: "Birds", transcript: "Teacher: Today we will learn about animals. In the morning we'll do birds, and after lunch we'll look at fish." },
        { id: "A1_46", audio: "audio/level_test/A1-Q46.mp3", text: "What food does the man not like?", options: ["Pasta", "Pizza", "Soup", "Fish"], correct: "Fish", transcript: "Man: My favourite food is pasta. I also like pizza and soup. I don't like fish very much." },
        { id: "A1_47", audio: "audio/level_test/A1-Q47.mp3", text: "What day is the dentist appointment?", options: ["Monday", "Tuesday", "Wednesday", "Thursday"], correct: "Wednesday", transcript: "Voice message: Hi, this is a reminder that your dentist appointment is on Wednesday at half past two. Please call us if you need to change it." },
        { id: "A1_48", audio: "audio/level_test/A1-Q48.mp3", text: "What time does the cartoon start?", options: ["Six o'clock", "Seven o'clock", "Eight o'clock", "Half past eight"], correct: "Six o'clock", transcript: "Man: The cinema has three screens. Screen one shows the new action film at seven. Screen two has the comedy at eight thirty. Screen three has the cartoon at six." },
        { id: "A1_49", audio: "audio/level_test/A1-Q49.mp3", text: "Where does the woman work?", options: ["In a school", "In a hotel", "In a hospital", "In a restaurant"], correct: "In a hospital", transcript: "Woman: I work in a hospital. I help the doctors and look after the patients. I wear a white uniform. I work long hours." },
        { id: "A1_50", audio: "audio/level_test/A1-Q50.mp3", text: "Where is the football match?", options: ["At the City Park", "At the Sports Centre", "At the Local Ground", "At the National Stadium"], correct: "At the National Stadium", transcript: "Man: I have two tickets for the football match on Saturday. The match starts at three o'clock. It's at the National Stadium." }
    ],
    A2: [
        { id: "A2_01", audio: "audio/level_test/A2-Q01.mp3", text: "What does the woman order to drink?", options: ["Water", "Tomato soup", "Coffee", "Orange juice"], correct: "Orange juice", transcript: "Waiter: Are you ready to order? Man: Yes. I'll have the chicken salad, please. Woman: And I'll have the tomato soup. Waiter: Anything to drink? Man: Just water for me. Woman: Orange juice, please." },
        { id: "A2_02", audio: "audio/level_test/A2-Q02.mp3", text: "At what time will the Manchester train now depart?", options: ["Five fifteen", "Five twenty", "Five thirty-five", "Five fifty"], correct: "Five thirty-five", transcript: "Announcer: Attention, please. The five fifteen train to Manchester is delayed by twenty minutes and will now depart at five thirty-five from platform three. We apologise for the inconvenience." },
        { id: "A2_03", audio: "audio/level_test/A2-Q03.mp3", text: "How much will the tourist pay in total?", options: ["Forty-five dollars", "Seventy dollars", "Eighty dollars", "Ninety dollars"], correct: "Seventy dollars", transcript: "Tourist: I'd like a day trip to the mountains tomorrow. Do you have any tours available? Agent: Yes, there's a coach tour leaving at eight AM. It includes a guide, lunch, and a waterfall visit. It returns at about six PM. Tourist: How much is it? Agent: Forty-five dollars per person, or thirty-five with a student ID. Tourist: I'll take two student tickets, please." },
        { id: "A2_04", audio: "audio/level_test/A2-Q04.mp3", text: "When is David Miller's appointment?", options: ["Thursday at ten AM", "Friday at ten AM", "Thursday at two PM", "Friday at two PM"], correct: "Friday at two PM", transcript: "Receptionist: Good morning, Park Street Surgery. How can I help? Man: I'd like to make an appointment with Dr. Jones, please. Receptionist: Dr. Jones is available Thursday at ten AM or Friday at two PM. Man: I'll take Friday at two PM. Receptionist: What's your name? Man: David Miller." },
        { id: "A2_05", audio: "audio/level_test/A2-Q05.mp3", text: "How much does the woman pay for the shirt?", options: ["Thirty dollars", "Twenty-five dollars", "Twenty-two dollars", "Twenty dollars"], correct: "Twenty-two dollars", transcript: "Woman: Excuse me, how much is this blue shirt? Shop assistant: It's normally thirty dollars, but today it's on sale for twenty-two. Woman: Great. And do you have it in large? Shop assistant: Yes, here you go." },
        { id: "A2_06", audio: "audio/level_test/A2-Q06.mp3", text: "What does the woman say about the gym in the evenings?", options: ["It is too expensive", "The equipment is old", "It is very crowded", "It closes early"], correct: "It is very crowded", transcript: "Man: I'm thinking of joining a gym. Have you tried the one on Park Road? Woman: Yes, I went there for six months. The equipment is great, but it gets very crowded in the evenings. Man: What about mornings? Woman: Much quieter. I used to go at seven and it was almost empty." },
        { id: "A2_07", audio: "audio/level_test/A2-Q07.mp3", text: "Why is the picnic cancelled this Saturday?", options: ["Jenny is ill", "The venue is closed", "There aren't enough people", "The weather forecast is bad"], correct: "The weather forecast is bad", transcript: "Hi, it's Jenny. I just wanted to let you know that the picnic this Saturday is cancelled because of the weather forecast. We're moving it to next Sunday instead. Let me know if that works for you." },
        { id: "A2_08", audio: "audio/level_test/A2-Q08.mp3", text: "How long did the applicant study in Paris?", options: ["One year", "Two years", "Three years", "Four years"], correct: "Two years", transcript: "Interviewer: So, you studied in Paris. How long were you there? Applicant: I was there for two years, from 2019 to 2021. Interviewer: And you speak French? Applicant: Yes, I'm quite fluent now. I also picked up some Italian while I was there." },
        { id: "A2_09", audio: "audio/level_test/A2-Q09.mp3", text: "How heavy is the passenger's bag?", options: ["Ten kilos", "Thirteen kilos", "Fifteen kilos", "Twenty kilos"], correct: "Fifteen kilos", transcript: "Passenger: I'd like to check in for the nine thirty flight to Rome. Staff: Do you have any bags to check in? Passenger: Just one, and it's fifteen kilos. Staff: The limit is twenty, so that's fine. Here's your boarding pass. Your seat is 14C." },
        { id: "A2_10", audio: "audio/level_test/A2-Q10.mp3", text: "What did the woman's sister say about the restaurant?", options: ["The food was poor but the service was fast", "The food was excellent but the service was slow", "The food and service were both excellent", "She didn't enjoy the food at all"], correct: "The food was excellent but the service was slow", transcript: "Woman: Did you hear? The new Italian restaurant on Bridge Street opened last week. Man: I walked past it. The queue was really long. Woman: I know. My sister went on Tuesday and waited forty minutes for a table. Man: Was it worth it? Woman: She said the food was excellent but the service was a bit slow." },
        { id: "A2_11", audio: "audio/level_test/A2-Q11.mp3", text: "Why should Mrs. Parker call back?", options: ["Because her test results are abnormal", "To get her prescription", "To change her doctor", "To book a follow-up appointment"], correct: "To book a follow-up appointment", transcript: "Hello, this is Dr. Evans' office calling for Mrs. Parker. Your test results have come back and everything looks normal. However, the doctor would like to see you for a routine follow-up next week. Please call us back at five five five, zero one nine eight to schedule an appointment. Thank you." },
        { id: "A2_12", audio: "audio/level_test/A2-Q12.mp3", text: "Why are Northern Line services suspended?", options: ["There is a fire", "There is a signal failure", "The trains are being cleaned", "A strike is taking place"], correct: "There is a signal failure", transcript: "Announcement: Attention passengers. Due to a signal failure, all services on the Northern Line are suspended until further notice. Please use the Victoria Line or surface buses as an alternative. We apologise for any inconvenience." },
        { id: "A2_13", audio: "audio/level_test/A2-Q13.mp3", text: "What will the weather be like in the afternoon?", options: ["Heavy rain continues", "Thunderstorms", "Sunny spells", "Fog and frost"], correct: "Sunny spells", transcript: "And now for today's weather. Expect heavy rain and strong winds across the south this morning, clearing to sunny spells by the afternoon. Temperatures will reach a maximum of fourteen degrees." },
        { id: "A2_14", audio: "audio/level_test/A2-Q14.mp3", text: "What starts tomorrow?", options: ["A new product launch", "A store closure for renovation", "A loyalty card programme", "An end-of-season sale"], correct: "An end-of-season sale", transcript: "Good evening, shoppers. The store will be closing in ten minutes. Please bring your items to the checkout. Also, don't miss our end-of-season sale starting tomorrow, with up to fifty percent off selected items." },
        { id: "A2_15", audio: "audio/level_test/A2-Q15.mp3", text: "What is the deadline to register for the first aid course?", options: ["Next Saturday", "The following Monday", "The Friday before the course", "Thursday at noon"], correct: "The Friday before the course", transcript: "The community centre will host a free first aid course next Saturday from ten AM to four PM. Places are limited. To register, email admin at community-centre dot org before Friday." },
        { id: "A2_16", audio: "audio/level_test/A2-Q16.mp3", text: "Where will Tom and Lucy go first on Saturday?", options: ["To the beach", "To the park", "To the cinema", "To the art gallery"], correct: "To the art gallery", transcript: "Tom: So, what shall we do on Saturday? Lucy: I'd love to go to the beach if the weather is nice. Tom: The forecast says rain in the morning but sunny in the afternoon. Lucy: Then how about we go to the new art gallery in the morning and the beach after lunch? Tom: That sounds perfect. Shall I pick you up at nine thirty? Lucy: Let's say ten. The gallery opens at nine but I want to miss the crowds." },
        { id: "A2_17", audio: "audio/level_test/A2-Q17.mp3", text: "What complaint did the guest have?", options: ["The room was too small", "Breakfast was not included", "The wifi was slow", "The bed was uncomfortable"], correct: "The wifi was slow", transcript: "Guest: I'd like to check out, please. My name's Johnson, room 207. Receptionist: Of course. How was your stay? Guest: Very comfortable, thank you. Although the wifi was quite slow. Receptionist: I'm sorry about that. Your total is one hundred and forty pounds, including breakfast. Guest: Can I pay by card? Receptionist: Of course." },
        { id: "A2_18", audio: "audio/level_test/A2-Q18.mp3", text: "Where is the olive oil now?", options: ["With the cooking oils", "Near the entrance", "In aisle seven, next to the pasta", "In aisle four, near the bread"], correct: "In aisle seven, next to the pasta", transcript: "Woman: Excuse me, I can't find the olive oil. Is it with the cooking oils? Shop assistant: It used to be, but we moved it. It's now in aisle seven, next to the pasta. Woman: And where's aisle seven? Shop assistant: Turn right at the end of this aisle and it's the third one on your left." },
        { id: "A2_19", audio: "audio/level_test/A2-Q19.mp3", text: "When will the daughter have her piano lesson?", options: ["Tuesday at four thirty", "Tuesday at five", "Thursday at four thirty", "Thursday at five"], correct: "Thursday at five", transcript: "Man: My daughter wants to learn the piano. Do you offer lessons for beginners? Music teacher: Yes. I have classes for children aged six and above. How old is she? Man: She's eight. Teacher: Perfect. I have a slot on Tuesday at four thirty or Thursday at five. Man: Thursday at five would suit us better." },
        { id: "A2_20", audio: "audio/level_test/A2-Q20.mp3", text: "Why does the man want to change his travel day to Saturday?", options: ["Flights are cheaper on Saturday", "He wants to arrive early and explore the city", "The conference starts on Sunday", "He missed the Sunday flight"], correct: "He wants to arrive early and explore the city", transcript: "Woman: Have you booked your flight for the conference yet? Man: Not yet. I was going to go on Sunday evening, but now I'm thinking of leaving Saturday instead. Woman: Why? Man: I want to arrive a day early to explore the city. I've never been to Vienna. Woman: That's a good idea. The conference doesn't start until Monday morning anyway." },
        { id: "A2_21", audio: "audio/level_test/A2-Q21.mp3", text: "Why did Clara decide to open a bakery?", options: ["Her family asked her to", "She was offered money to start a business", "She was made redundant and followed her dream", "She always wanted to leave school early"], correct: "She was made redundant and followed her dream", transcript: "Presenter: Today we're speaking with Clara, who recently opened a bakery in town. Clara, what made you decide to open a bakery? Clara: I always loved baking, but I worked in an office for twelve years. Last year I was made redundant and decided it was the perfect time to follow my dream." },
        { id: "A2_22", audio: "audio/level_test/A2-Q22.mp3", text: "How much has the caller already won?", options: ["One hundred pounds", "Two hundred pounds", "Three hundred pounds", "Five hundred pounds"], correct: "Two hundred pounds", transcript: "Host: Congratulations, you've made it to the final round. You have already won two hundred pounds. If you answer correctly, you win the total prize of five hundred pounds. If you get it wrong, you lose everything and go home with nothing. Caller: I'll try!" },
        { id: "A2_23", audio: "audio/level_test/A2-Q23.mp3", text: "What will be the dessert?", options: ["Mushroom soup", "Roasted chicken", "Ice cream", "Chocolate mousse"], correct: "Chocolate mousse", transcript: "Chef: Today we are making a three-course dinner. We'll start with a mushroom soup, then a roasted chicken with vegetables, and finish with a chocolate mousse for dessert." },
        { id: "A2_24", audio: "audio/level_test/A2-Q24.mp3", text: "When does the presenter recommend visiting Tokyo?", options: ["In summer, for the festivals", "In winter, for the snow", "In autumn, for the leaves", "In spring, for the cherry blossoms"], correct: "In spring, for the cherry blossoms", transcript: "Presenter: If you're visiting Tokyo for the first time, I recommend arriving in spring. The cherry blossoms are at their best in late March and early April, and the weather is mild and pleasant." },
        { id: "A2_25", audio: "audio/level_test/A2-Q25.mp3", text: "Why are the three libraries being closed?", options: ["They are being renovated", "They are moving to a new location", "There are not enough visitors", "Budget cuts have been made"], correct: "Budget cuts have been made", transcript: "Reporter: The city council voted yesterday to close three local libraries due to budget cuts. The closures will affect around five thousand regular visitors. The decision has been strongly criticised by community groups." },
        { id: "A2_26", audio: "audio/level_test/A2-Q26.mp3", text: "What delivery option does the man choose?", options: ["Express delivery", "Same-day delivery", "Registered post", "Standard delivery"], correct: "Standard delivery", transcript: "Man: I'd like to send this package to Canada. How long will standard delivery take? Clerk: About two to three weeks. Express delivery gets it there in five to seven days. Man: How much is express? Clerk: That would be eighteen pounds fifty. Man: I'll go with standard, please." },
        { id: "A2_27", audio: "audio/level_test/A2-Q27.mp3", text: "What does the woman want to do this week?", options: ["Sign a rental contract", "Pay the deposit", "View the flat", "Meet the other tenants"], correct: "View the flat", transcript: "Woman: Hi, I'm calling about the flat I saw advertised online. Is it still available? Landlord: Yes, it is. It's a two-bedroom flat on the fourth floor. No lift, I'm afraid. Woman: How much is the rent? Landlord: Eight hundred and fifty a month, bills not included. Woman: Could I come and view it this week? Landlord: How about Friday evening at six?" },
        { id: "A2_28", audio: "audio/level_test/A2-Q28.mp3", text: "How will the staff identify the umbrella?", options: ["By its brand label", "By its size", "By the colour and the name on the handle", "By the train number"], correct: "By the colour and the name on the handle", transcript: "Man: I left my umbrella on the train this morning. Officer: Can you describe it? Man: It's blue and white stripes, with a wooden handle. My name is written on the handle. Officer: One moment. We do have an umbrella matching that description. Let me get it." },
        { id: "A2_29", audio: "audio/level_test/A2-Q29.mp3", text: "What does the woman decide to buy?", options: ["A kitchen gadget", "A recipe card set", "A cooking magazine subscription", "A book"], correct: "A book", transcript: "Woman: I'm looking for a birthday present for my dad. He likes cooking and reading. Shop assistant: We have a great selection of cookbooks. And we also have some kitchen gadgets that are very popular. Woman: Actually, I think he'd prefer a book. Something practical, not too long. Shop assistant: I'd recommend Home Cooking Made Simple. It has excellent reviews." },
        { id: "A2_30", audio: "audio/level_test/A2-Q30.mp3", text: "How much is the annual membership?", options: ["Three hundred pounds", "Three hundred and twenty pounds", "Three hundred and fifty pounds", "Three hundred and eighty pounds"], correct: "Three hundred and twenty pounds", transcript: "Receptionist: Welcome. Are you a member? Man: No, I'd like to join. What are the membership options? Receptionist: We have monthly at thirty-five, or annual at three hundred and twenty. Man: And can I come in the evenings? Receptionist: The gym is open until ten PM on weekdays and eight PM on weekends." },
        { id: "A2_31", audio: "audio/level_test/A2-Q31.mp3", text: "How should students submit their essays?", options: ["By email", "In person, during class", "Through the online portal", "In the teacher's pigeonhole"], correct: "In person, during class", transcript: "Teacher: Remember, your essays are due next Thursday, not Friday. Please hand them in during class, not by email. Student: Can we get an extension if we need one? Teacher: Requests for extensions must be made at least three days before the deadline." },
        { id: "A2_32", audio: "audio/level_test/A2-Q32.mp3", text: "What should the man do to get to Stratford?", options: ["Continue straight ahead", "Turn right at the next roundabout", "Go back two miles and turn left after the church", "Follow the motorway for three miles"], correct: "Go back two miles and turn left after the church", transcript: "Man: Excuse me, is this the road to Stratford? Attendant: No, you've gone too far. You need to go back about two miles and take the turning on the left, just after the church. Man: Thank you. Is it well signposted? Attendant: Yes, there's a brown sign for Stratford." },
        { id: "A2_33", audio: "audio/level_test/A2-Q33.mp3", text: "How many times can the woman renew the digital book?", options: ["Once", "Twice", "Three times", "As many times as she likes"], correct: "Twice", transcript: "Librarian: I'm sorry, but this book has a two-week waiting list. Woman: Is there a digital version I can borrow? Librarian: Yes. You'll need to download our app and use your library card number to access it. Woman: That sounds easy enough. How long can I borrow the digital version for? Librarian: Two weeks as well, but you can renew it twice if you need to." },
        { id: "A2_34", audio: "audio/level_test/A2-Q34.mp3", text: "Why will the woman be late to the staff meeting?", options: ["She is travelling from another office", "She has a doctor's appointment", "She has another meeting that finishes at the same time", "She forgot to put it in her diary"], correct: "She has another meeting that finishes at the same time", transcript: "Man: Are you going to the staff meeting on Wednesday? Woman: Yes, but I'll be about ten minutes late. I have another meeting that finishes at the same time. Man: I'll let the manager know. Woman: Thanks. Can you save me a seat?" },
        { id: "A2_35", audio: "audio/level_test/A2-Q35.mp3", text: "What was the final score?", options: ["One-nil", "Two-one", "Three-nil", "Three-one"], correct: "Three-one", transcript: "Commentator: And there it is, the final whistle. United win three-one. It was a close first half, but three goals in the second half sealed the victory for the home side." },
        { id: "A2_36", audio: "audio/level_test/A2-Q36.mp3", text: "Why did the boy fail the practical test?", options: ["He went through a red light", "He drove too fast", "He hit a kerb when parking", "He failed the theory part"], correct: "He hit a kerb when parking", transcript: "Girl: Did you pass the driving test? Boy: No. I passed the theory but failed the practical. I hit a kerb when parking. Girl: Oh no. When can you retake it? Boy: I have to wait three weeks. I'm booking extra lessons in the meantime." },
        { id: "A2_37", audio: "audio/level_test/A2-Q37.mp3", text: "What is the dog wearing?", options: ["A blue collar with a bell", "A green collar with a tag", "A red collar with a name tag", "No collar, just a tag"], correct: "A red collar with a name tag", transcript: "Woman: Hello. I'd like to report a missing dog. He got out of the garden this morning. Officer: Of course. What does he look like? Woman: He's a medium-sized golden retriever, about three years old. He's wearing a red collar with a name tag." },
        { id: "A2_38", audio: "audio/level_test/A2-Q38.mp3", text: "When will the guest check in?", options: ["July 14th", "July 15th", "July 16th", "July 17th"], correct: "July 15th", transcript: "Guest: I'd like a double room for two nights, checking in on the fourteenth of July. Receptionist: I'm sorry, we're fully booked on the fourteenth. We have availability from the fifteenth. Guest: That's fine. I'll take the fifteenth and sixteenth then." },
        { id: "A2_39", audio: "audio/level_test/A2-Q39.mp3", text: "What interests the applicant most about the job?", options: ["The high salary", "Working from home", "The international travel", "The flexible hours"], correct: "The international travel", transcript: "Interviewer: How did you hear about this position? Applicant: A friend who works here mentioned it to me. Interviewer: And what interests you most about the role? Applicant: I'm particularly keen on the international travel involved. I've always wanted to work across different markets." },
        { id: "A2_40", audio: "audio/level_test/A2-Q40.mp3", text: "What does the man think about the film's ending?", options: ["It was the best part", "It was scary and exciting", "It was too long", "It was disappointing"], correct: "It was disappointing", transcript: "Woman: Have you seen that new thriller at the cinema? Man: Yes, I went on Friday with my brother. It was quite tense, but the ending was disappointing. Woman: Really? Everyone I know loved it. Man: The first two hours were great. It just fell apart at the end." },
        { id: "A2_41", audio: "audio/level_test/A2-Q41.mp3", text: "How long does it take to walk to the park?", options: ["Two minutes", "Five minutes", "Ten minutes", "Fifteen minutes"], correct: "Five minutes", transcript: "Man: Excuse me, could you tell me how to get to the central park? Woman: Yes. Walk down this street, cross at the traffic lights, and the park gates are directly opposite. Man: Is it far? Woman: About five minutes on foot." },
        { id: "A2_42", audio: "audio/level_test/A2-Q42.mp3", text: "How often should the customer take the syrup?", options: ["Once a day", "Twice a day", "Three times a day", "Four times a day"], correct: "Three times a day", transcript: "Pharmacist: Can I help you? Customer: Yes, I have a bad cough and a sore throat. Can you recommend something? Pharmacist: I'd suggest this syrup. Take ten millilitres three times a day. If it doesn't improve in five days, see your doctor." },
        { id: "A2_43", audio: "audio/level_test/A2-Q43.mp3", text: "How often does the number twenty-four bus run?", options: ["Every five minutes", "Every ten minutes", "Every fifteen minutes", "Every twenty minutes"], correct: "Every fifteen minutes", transcript: "Passenger: Does this bus go to the university? Driver: No. You want the number twenty-four. It stops just across the road. Passenger: How often does it run? Driver: Every fifteen minutes." },
        { id: "A2_44", audio: "audio/level_test/A2-Q44.mp3", text: "What time is the reservation made for?", options: ["Seven o'clock", "Seven-thirty", "Eight o'clock", "Eight-thirty"], correct: "Eight o'clock", transcript: "Man: I'd like to book a table for four people for Saturday evening. Receptionist: What time were you thinking? Man: Around seven-thirty. Receptionist: I'm afraid we're full at seven-thirty. Would eight o'clock work? Man: Yes, that's fine." },
        { id: "A2_45", audio: "audio/level_test/A2-Q45.mp3", text: "What is the closing date for applications?", options: ["The first of the month", "The tenth of the month", "The fifteenth of the month", "The twentieth of the month"], correct: "The fifteenth of the month", transcript: "Looking for part-time work? ABC Retail is hiring weekend staff. No experience necessary. Training provided. Apply online at ABCjobs dot com. The closing date for applications is the fifteenth of this month." },
        { id: "A2_46", audio: "audio/level_test/A2-Q46.mp3", text: "How long will construction of the sports centre take?", options: ["Six months", "One year", "Two years", "Three years"], correct: "Two years", transcript: "The local council has approved plans to build a new sports centre in the east of the city. The centre will include an Olympic-size swimming pool, four tennis courts, and a gym. Construction is expected to begin next spring and will take approximately two years." },
        { id: "A2_47", audio: "audio/level_test/A2-Q47.mp3", text: "What does the doctor suggest trying first?", options: ["Sleeping pills", "A herbal tea remedy", "Relaxation techniques", "Changing jobs again"], correct: "Relaxation techniques", transcript: "Man: I'm having trouble sleeping. I lie awake for hours. Doctor: How long has this been happening? Man: About three weeks, since I changed jobs. Doctor: I'd like to try some relaxation techniques before considering medication. Avoid screens for an hour before bed." },
        { id: "A2_48", audio: "audio/level_test/A2-Q48.mp3", text: "What does the man suggest the woman do?", options: ["Move out immediately", "Fix the heating herself", "Stop paying rent", "Contact the housing advice centre"], correct: "Contact the housing advice centre", transcript: "Woman: The heating has been broken for a week. I've already called the landlord twice. Man: And he hasn't done anything? Woman: No. I'm going to write a formal letter today. Man: You might also want to mention it to the housing advice centre." },
        { id: "A2_49", audio: "audio/level_test/A2-Q49.mp3", text: "Where were the glasses?", options: ["On the kitchen table", "In the bedroom", "Behind the sofa cushion", "In the man's jacket"], correct: "Behind the sofa cushion", transcript: "Man: I can't find my glasses anywhere. Woman: When did you last have them? Man: This morning, when I was reading the paper. Woman: Did you check the kitchen table? Man: Yes. Oh wait, here they are. They fell behind the sofa cushion." },
        { id: "A2_50", audio: "audio/level_test/A2-Q50.mp3", text: "When do lectures begin?", options: ["Monday", "Tuesday", "Wednesday", "Thursday"], correct: "Wednesday", transcript: "Welcome to Greenfield University. Registration takes place in the main hall on Monday and Tuesday. Please bring two forms of ID and your acceptance letter. Lectures begin on Wednesday. If you have any questions, the student support office is on the ground floor of building C." }
    ],
    B1: [
    { 
        id: "B1_01", 
